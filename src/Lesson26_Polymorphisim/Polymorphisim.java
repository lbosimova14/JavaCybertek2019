...
abstract class AbstractClass{
	...
	public void get() {
		System.out.println("this get method from super chrome");
	}
}


public class Polymorphisim extends AbstractClass {
	//          sub                 super
	public static void Test() {//this method is not overriden
		
	}
	//@Override not overriding bc static
	public static  void ByLinkText() {
		System.out.println("Link text sub");
	}
	@Override
	public void get() {
		System.out.println("this firefox driver");
	}
	
	
	public static void main(String[] args) {
		//AbstractClass obj = new AbstractClass();//cannot create obj, bc abstaction is concrete
		//but we can give as reference type
		AbstractClass obj1=new Polymorphisim();
		//if we make the abstract class as reference type , the object Must be created from it's sub class (non- 
	
	obj1.ByLinkText();//Link text super   calling super class method
	obj1.get();//this firefox driver   now ,this overriden method and calling from sub class
